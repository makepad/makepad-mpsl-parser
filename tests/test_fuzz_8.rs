...
void SpriteBlock( inout vec3 color, float x, float y )
{
    ...
    color = vec3( float( 0 ) / 255.0, float( 0 ) / 255.0, float( 0 ) / 255.0 );
 color = idx == 2.0 ? vec3( float( 231 ) / 255.0, float( 90 ) / 255.0, float( 16 ) / 255.0 ) : color;
 color = idx == 3.0 ? vec3( float( 247 ) / 255.0, float( 214 ) / 255.0, float( 181 ) / 255.0 ) : color;
}
void SpriteHill( inout vec3 color, float x, float y )
{
 ...
 color = idx == 1.0 ? vec3( float( 0 ) / 255.0, float( 0 ) / 255.0, float( 0 ) / 255.0 ) : color;
 color = idx == 2.0 ? vec3( float( 0 ) / 255.0, float( 173 ) / 255.0, float( 0 ) / 255.0 ) : color;
}
void SpritePipe( inout vec3 color, float x, float y, float h )
{
 ...
 color = idx == 1.0 ? vec3( float( 0 ) / 255.0, float( 0 ) / 255.0, float( 0 ) / 255.0 ) : color;
 color = idx == 2.0 ? vec3( float( 0 ) / 255.0, float( 173 ) / 255.0, float( 0 ) / 255.0 ) : color;
 color = idx == 3.0 ? vec3( float( 189 ) / 255.0, float( 255 ) / 255.0, float( 24 ) / 255.0 ) : color;
}
void SpriteCloud( inout vec3 color, float x, float y, float isBush )
{
 ...
 idx = mod( floor( idx / pow( 4.0, mod( x, 11.0 ) ) ), 4.0 );
 vec3 colorB = isBush == 1.0 ? vec3( float( 0 ) / 255.0, float( 173 ) / 255.0, float( 0 ) / 255.0 ) : vec3( float( 57 ) / 255.0, float( 189 ) / 255.0, float( 255 ) / 255.0 );
 vec3 colorC = isBush == 1.0 ? vec3( float( 189 ) / 255.0, float( 255 ) / 255.0, float( 24 ) / 255.0 ) : vec3( float( 254 ) / 255.0, float( 254 ) / 255.0, float( 254 ) / 255.0 );
 color = idx == 1.0 ? vec3( float( 0 ) / 255.0, float( 0 ) / 255.0, float( 0 ) / 255.0 ) : color;
...
void SpriteFlag( inout vec3 color, float x, float y )
{
 ...
 idx = mod( floor( idx / pow( 4.0, mod( x, 8.0 ) ) ), 4.0 );
 color = idx == 1.0 ? vec3( float( 0 ) / 255.0, float( 173 ) / 255.0, float( 0 ) / 255.0 ) : color;
 color = idx == 2.0 ? vec3( float( 255 ) / 255.0, float( 255 ) / 255.0, float( 255 ) / 255.0 ) : color;
}
void SpriteCastleFlag( inout vec3 color, float x, float y )
{
 ...
 idx = mod( floor( idx / pow( 4.0, mod( x, 11.0 ) ) ), 4.0 );
 color = idx == 1.0 ? vec3( float( 181 ) / 255.0, float( 49 ) / 255.0, float( 33 ) / 255.0 ) : color;
    color = idx == 2.0 ? vec3( float( 230 ) / 255.0, float( 156 ) / 255.0, float( 33 ) / 255.0 ) : color;
 color = idx == 3.0 ? vec3( float( 255 ) / 255.0, float( 255 ) / 255.0, float( 255 ) / 255.0 ) : color;
}
void SpriteGoomba( inout vec3 color, float x, float y, float frame )
{
 float idx = 0.0;
  ...
  idx = y == 0.0 ? ( x <= 7.0 ? 1364.0 : 5456.0 ) : idx;
    ...
    idx = mod( floor( idx / pow( 4.0, mod( x, 8.0 ) ) ), 4.0 );
 color = idx == 1.0 ? vec3( float( 0 ) / 255.0, float( 0 ) / 255.0, float( 0 ) / 255.0 ) : color;
 color = idx == 2.0 ? vec3( float( 153 ) / 255.0, float( 75 ) / 255.0, float( 12 ) / 255.0 ) : color;
 color = idx == 3.0 ? vec3( float( 255 ) / 255.0, float( 200 ) / 255.0, float( 184 ) / 255.0 ) : color;
}
void SpriteKoopa( inout vec3 color, float x, float y, float frame )
{
 ...
 idx = mod( floor( idx / pow( 4.0, mod( x, 8.0 ) ) ), 4.0 );
 color = idx == 1.0 ? vec3( float( 30 ) / 255.0, float( 132 ) / 255.0, float( 0 ) / 255.0 ) : color;
 color = idx == 2.0 ? vec3( float( 215 ) / 255.0, float( 141 ) / 255.0, float( 34 ) / 255.0 ) : color;
 color = idx == 3.0 ? vec3( float( 255 ) / 255.0, float( 255 ) / 255.0, float( 255 ) / 255.0 ) : color;
}
void SpriteQuestion( inout vec3 color, float x, float y, float t )
{
 ...
 color = idx == 1.0 ? vec3( float( 0 ) / 255.0, float( 0 ) / 255.0, float( 0 ) / 255.0 ) : color;
 color = idx == 2.0 ? vec3( float( 231 ) / 255.0, float( 90 ) / 255.0, float( 16 ) / 255.0 ) : color;
 color = idx == 3.0 ? mix( vec3( float( 255 ) / 255.0, float( 165 ) / 255.0, float( 66 ) / 255.0 ), vec3( float( 231 ) / 255.0, float( 90 ) / 255.0, float( 16 ) / 255.0 ), t ) : color;
}
...
void SpriteMario( inout vec3 color, float x, float y, float frame )
{
 ...
 if ( frame == 0.0 )
    ...
    idx = mod( floor( idx / pow( 4.0, mod( x, 8.0 ) ) ), 4.0 );
 color = idx == 1.0 ? vec3( float( 106 ) / 255.0, float( 107 ) / 255.0, float( 4 ) / 255.0 ) : color;
 color = idx == 2.0 ? vec3( float( 177 ) / 255.0, float( 52 ) / 255.0, float( 37 ) / 255.0 ) : color;
 color = idx == 3.0 ? vec3( float( 227 ) / 255.0, float( 157 ) / 255.0, float( 37 ) / 255.0 ) : color;
}
     ...
     if ( time >= questionHitTime )
        {
         SpriteQuestion( color, questionX, questionY, 1.0 );
            ...
            {
                color = vec3( float( 231 ) / 255.0, float( 90 ) / 255.0, float( 16 ) / 255.0 );
            }
        }
        else
        {
...
void DrawW( inout vec3 color, float x, float y )
{
    if ( x >= 0.0 && x < 14.0 && y >= 0.0 && y < 14.0 )
    {
        ...
        {
            color = vec3( float( 255 ) / 255.0, float( 255 ) / 255.0, float( 255 ) / 255.0 );
        }
    }
}
...
void DrawGame( inout vec3 color, float time, float pixelX, float pixelY, float screenWidth, float screenHeight )
{
    ...
    color = vec3( float( 92 ) / 255.0, float( 148 ) / 255.0, float( 252 ) / 255.0 );
 ...
 if ( cloudX >= 0.0 && cloudX < 32.0 + 16.0 * cloudSeg )
    ...
    {
        color = vec3( float( 189 ) / 255.0, float( 255 ) / 255.0, float( 24 ) / 255.0 );
    }
...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    vec3 color = vec3( float( 92 ) / 255.0, float( 148 ) / 255.0, float( 252 ) / 255.0 );
